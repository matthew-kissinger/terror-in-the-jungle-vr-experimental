...
export class PlayerHealthSystem implements GameSystem {
  private playerState: PlayerState = {
    ...
    maxHealth: 150,  // Now takes 4-5 shots instead of 3
    isAlive: true,
    isDead: false,
    deathTime: 0,
    respawnTime: 3.0, // 3 second respawn timer
    invulnerabilityTime: 0 // No spawn protection to prevent exploitation
  };
  ...
  private respawn(position: THREE.Vector3): void {
    ...
    this.playerState.invulnerabilityTime = 0; // No spawn protection to prevent exploitation
